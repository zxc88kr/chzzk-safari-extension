...
- **블라인드 채팅 보기** — 가려진 채팅을 원문으로 되돌림
- **랭킹 숨기기** — 채팅창 후원·통나무 랭킹 숨김

환영 인사·필터링 안내 같은 채팅창 시스템 공지는 **항상** 숨겨집니다. (끄는 설정은 없습니다)

블라인드 채팅 보기는 **보고 있는 동안 가려진 메시지**만 되돌립니다. 채팅은 먼저 도착하고 블라인드는 나중에 오는 별도 신호라, 도착한 원문을 기억해 두었다가 되돌리는 방식이기 때문입니다. 내가 보기 전에 이미 가려진 메시지는 원문이 오지 않아 복원할 수 없습니다.
